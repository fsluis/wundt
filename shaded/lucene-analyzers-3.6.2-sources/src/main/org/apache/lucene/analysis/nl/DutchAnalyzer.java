package org.apache.lucene3.analysis.nl;
...
import org.apache.lucene3.analysis.CharArrayMap;
...
import org.apache.lucene3.analysis.WordlistLoader;
import org.apache.lucene3.analysis.miscellaneous.StemmerOverrideFilter;
...
import org.apache.lucene3.analysis.standard.StandardAnalyzer;  // for javadoc
...
public final class DutchAnalyzer extends ReusableAnalyzerBase {
  ...
  protected TokenStreamComponents createComponents(String fieldName,
    ...
    if (matchVersion.onOrAfter(Version.LUCENE_31)) {
      ...
      result = new SnowballFilter(result, new org.tartarus.snowball3.ext.DutchStemmer());
