package org.apache.lucene3.analysis.compound;
...
import org.apache.lucene3.analysis.TokenFilter; // for javadocs
import org.apache.lucene3.analysis.TokenStream;
import org.apache.lucene3.analysis.compound.hyphenation.Hyphenation;
import org.apache.lucene3.analysis.compound.hyphenation.HyphenationTree;
 ...
 * dictionaries.
 * </ul>
 * <p>If you pass in a {@link org.apache.lucene3.analysis.CharArraySet} as dictionary,
 * it should be case-insensitive unless it contains only lowercased entries and you
 * have {@link org.apache.lucene3.analysis.LowerCaseFilter} before this filter in your analysis chain.
...
public class HyphenationCompoundWordTokenFilter extends
   ...
   * @param input the {@link TokenStream} to process
   * @param hyphenator the hyphenation pattern tree to use for hyphenation
   * @param dictionary the word dictionary to match against. If this is a {@link org.apache.lucene3.analysis.CharArraySet CharArraySet} it must have set ignoreCase=false and only contain
   *        lower case strings. 
