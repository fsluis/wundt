package org.apache.lucene3.analysis.snowball;
...
import org.apache.lucene3.analysis.tr.TurkishLowerCaseFilter; // javadoc @link
import org.apache.lucene3.analysis.LowerCaseFilter; // javadoc @link
import org.tartarus.snowball3.SnowballProgram;

/**
 * A filter that stems words using a Snowball-generated stemmer.
 *
 * Available stemmers are listed in {@link org.tartarus.snowball3.ext}.
...
public final class SnowballFilter extends TokenFilter {
   ...
   * e.g., the stemmer in {@link org.tartarus.snowball3.ext.EnglishStemmer} is named "English".
   *
  ...
  public SnowballFilter(TokenStream in, String name) {
    super(in);
    try {      
      Class<?> stemClass = Class.forName("org.tartarus.snowball3.ext." + name + "Stemmer");
