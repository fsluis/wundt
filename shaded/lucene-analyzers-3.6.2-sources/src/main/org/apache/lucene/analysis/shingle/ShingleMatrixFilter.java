...
import org.apache.lucene3.analysis.Token;
import org.apache.lucene3.analysis.TokenStream;
import org.apache.lucene3.analysis.miscellaneous.EmptyTokenStream;
import org.apache.lucene3.analysis.payloads.PayloadHelper;
import org.apache.lucene3.analysis.shingle.ShingleMatrixFilter.Matrix.Column.Row;
import org.apache.lucene3.analysis.tokenattributes.CharTermAttribute;
import org.apache.lucene3.analysis.tokenattributes.FlagsAttribute;
import org.apache.lucene3.analysis.tokenattributes.OffsetAttribute;
import org.apache.lucene3.analysis.tokenattributes.PayloadAttribute;
import org.apache.lucene3.analysis.tokenattributes.PositionIncrementAttribute;
 ...
 * {@link org.apache.lucene3.analysis.shingle.ShingleMatrixFilter.TokenSettingsCodec}.
 * There are three simple implementations for demonstrational purposes,
 * see {@link org.apache.lucene3.analysis.shingle.ShingleMatrixFilter.OneDimensionalNonWeightedTokenSettingsCodec},
 * {@link org.apache.lucene3.analysis.shingle.ShingleMatrixFilter.TwoDimensionalNonWeightedSynonymTokenSettingsCodec}
 * and {@link org.apache.lucene3.analysis.shingle.ShingleMatrixFilter.SimpleThreeDimensionalTokenSettingsCodec}.
 *
 ...
 * See {@link #calculateShingleWeight(org.apache.lucene3.analysis.Token, java.util.List, int, java.util.List, java.util.List)}.
 * <p/>
 ...
 * the ones located in <code>org.apache.lucene3.analysis.tokenattributes</code>. It also uses
...
public final class ShingleMatrixFilter extends TokenStream {
  ...
  public static abstract class TokenSettingsCodec {
    ...
    /**
     * Retrieves information on how a {@link org.apache.lucene3.analysis.Token} is to be inserted to a {@link org.apache.lucene3.analysis.shingle.ShingleMatrixFilter.Matrix}.
     * @param token
    ...
    /**
     * Sets information on how a {@link org.apache.lucene3.analysis.Token} is to be inserted to a {@link org.apache.lucene3.analysis.shingle.ShingleMatrixFilter.Matrix}.
     *
     * @param token
  ...
  /**
   * Used to describe how a {@link org.apache.lucene3.analysis.Token} is to be inserted to a {@link org.apache.lucene3.analysis.shingle.ShingleMatrixFilter.Matrix}.
   * @see org.apache.lucene3.analysis.shingle.ShingleMatrixFilter.TokenSettingsCodec#getTokenPositioner(org.apache.lucene3.analysis.Token)
   * @see org.apache.lucene3.analysis.shingle.ShingleMatrixFilter.TokenSettingsCodec#setTokenPositioner(org.apache.lucene3.analysis.Token,org.apache.lucene3.analysis.shingle.ShingleMatrixFilter.TokenPositioner)
   */
...
//        }
  ...
  /**
   * Using this codec makes a {@link ShingleMatrixFilter} act like {@link org.apache.lucene3.analysis.shingle.ShingleFilter}.
