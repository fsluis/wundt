...
import org.apache.lucene33.document.AbstractField;  // for javadocs
import org.apache.lucene33.document.Document;
import org.apache.lucene33.search.IndexSearcher;
import org.apache.lucene33.search.TermQuery;
import org.apache.lucene33.store.Directory;
import org.apache.lucene33.store.FSDirectory;
import org.apache.lucene33.store.IndexInput;
import org.apache.lucene33.util.CommandLineUtil;
...
public class CheckIndex {
  ...
  public static class Status {
    ...
    public static class SegmentInfoStatus {
       ...
       *  has position data
       *  @see AbstractField#setIndexOptions(org.apache.lucene33.index.FieldInfo.IndexOptions) */
  ...
  /** Command-line interface to check and fix an index.
    ...
    Run it like this:
    <pre>
    java -ea:org.apache.lucene33... org.apache.lucene33.index.CheckIndex pathToIndex [-fix] [-segment X] [-segment Y]
    </pre>
    <ul>
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    if (indexPath == null) {
      ...
      System.out.println("\nUsage: java org.apache.lucene33.index.CheckIndex pathToIndex [-fix] [-segment X] [-segment Y] [-dir-impl X]\n" +
                         "\n" +
    ...
    if (!assertsOn())
      System.out.println("\nNOTE: testing will be more thorough if you run java with '-ea:org.apache.lucene33...', so assertions are enabled");
