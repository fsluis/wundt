...
import org.apache.lucene33.analysis.Analyzer;
import org.apache.lucene33.analysis.LimitTokenCountAnalyzer;
import org.apache.lucene33.document.Document;
import org.apache.lucene33.index.IndexWriterConfig.OpenMode;
import org.apache.lucene33.search.Query;
import org.apache.lucene33.search.Similarity;
import org.apache.lucene33.store.AlreadyClosedException;
import org.apache.lucene33.store.BufferedIndexInput;
import org.apache.lucene33.store.Directory;
import org.apache.lucene33.store.Lock;
import org.apache.lucene33.store.LockObtainFailedException;
import org.apache.lucene33.util.Constants;
import org.apache.lucene33.util.StringHelper;
import org.apache.lucene33.util.ThreadInterruptedException;
import org.apache.lucene33.util.TwoPhaseCommit;
...
public class IndexWriter implements Closeable, TwoPhaseCommit {
   ...
   *  index
   * @param deletionPolicy see <a href="#deletionPolicy">above</a>
   * @param mfl {@link org.apache.lucene33.index.IndexWriter.MaxFieldLength}, whether or not to limit field lengths.  Value is in number of terms/tokens
   * @throws CorruptIndexException if the index is corrupt
   * @throws LockObtainFailedException if another writer
   *  has this index open (<code>write.lock</code> could not
   *  be obtained)
   ...
   * @param a the analyzer to use
   * @param deletionPolicy see <a href="#deletionPolicy">above</a>
   * @param mfl whether or not to limit field lengths, value is in number of terms/tokens.  See {@link org.apache.lucene33.index.IndexWriter.MaxFieldLength}.
