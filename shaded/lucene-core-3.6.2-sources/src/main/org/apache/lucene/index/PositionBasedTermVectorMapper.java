...
public class PositionBasedTermVectorMapper extends TermVectorMapper{
   ...
   *
   * @return A map between field names and a Map.  The sub-Map key is the position as the integer, the value is {@link org.apache.lucene33.index.PositionBasedTermVectorMapper.TVPositionInfo}.
   */
