package org.apache.lucene33.index;
...
import org.apache.lucene33.search.SearcherManager; // javadocs
import org.apache.lucene33.search.Similarity;
import org.apache.lucene33.store.*;
...
public abstract class IndexReader implements Cloneable,Closeable {
  ...
  /**
   * Open a near real time IndexReader from the {@link org.apache.lucene33.index.IndexWriter}.
   *
   ...
   * @see org.apache.lucene33.document.Field.TermVector
   */
  ...
  /**
   * Get the {@link org.apache.lucene33.document.Document} at the <code>n</code>
   * <sup>th</sup> position. The {@link FieldSelector} may be used to determine
   * what {@link org.apache.lucene33.document.Field}s to load and how they should
   * be loaded. <b>NOTE:</b> If this Reader (more specifically, the underlying
   * <code>FieldsReader</code>) is closed before the lazy
   * {@link org.apache.lucene33.document.Field} is loaded an exception may be
   * thrown. If you want the value of a lazy
   * {@link org.apache.lucene33.document.Field} to be available after closing you
   ...
   *         {@link org.apache.lucene33.document.Document} at the nth position
   * @throws CorruptIndexException if the index is corrupt
   * @throws IOException if there is a low-level IO error
   ...
   * org.apache.lucene33.document.Fieldable#setBoost(float) boost} and its {@link Similarity#lengthNorm(String,
