package org.apache.lucene33.search.spans;
/**
...
public abstract class SpanPositionCheckQuery extends SpanQuery implements Cloneable {
   ...
   * "match" {@link org.apache.lucene33.search.spans.SpanQuery}.
   *
   * This is only called if the underlying {@link org.apache.lucene33.search.spans.Spans#next()} for the
   * match is successful
   *
   *
   * @param spans The {@link org.apache.lucene33.search.spans.Spans} instance, positioned at the spot to check
   * @return whether the match is accepted, rejected, or rejected and should move to the next doc.
   *
   * @see org.apache.lucene33.search.spans.Spans#next()
   *
   */
