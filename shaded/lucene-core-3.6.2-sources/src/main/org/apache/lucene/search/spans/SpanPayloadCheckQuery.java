 ...
 *  the given position.
 *<p/>
 * Do not use this with an SpanQuery that contains a {@link org.apache.lucene33.search.spans.SpanNearQuery}.  Instead, use
 * {@link SpanNearPayloadCheckQuery} since it properly handles the fact that payloads
 * aren't ordered by {@link org.apache.lucene33.search.spans.SpanNearQuery}.
 *
 **/
public class SpanPayloadCheckQuery extends SpanPositionCheckQuery{
  ...
  /**
   *
   * @param match The underlying {@link org.apache.lucene33.search.spans.SpanQuery} to check
