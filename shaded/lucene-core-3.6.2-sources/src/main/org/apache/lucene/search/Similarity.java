package org.apache.lucene33.search;
...
import org.apache.lucene33.index.FieldInvertState;
import org.apache.lucene33.index.Term;
import org.apache.lucene33.search.Explanation.IDFExplanation;
import org.apache.lucene33.util.SmallFloat;
import org.apache.lucene33.util.VirtualMethod;
 ...
 *      {@link org.apache.lucene33.search.DefaultSimilarity#tf(float) DefaultSimilarity} is:
 *
 *      <br>&nbsp;<br>
 *      <table cellpadding="2" cellspacing="2" border="0" align="center" style="width:auto">
 *        <tr>
 *          <td valign="middle" align="right" rowspan="1">
 *            {@link org.apache.lucene33.search.DefaultSimilarity#tf(float) tf(t in d)} &nbsp; = &nbsp;
 *          </td>
 ...
 *      {@link org.apache.lucene33.search.DefaultSimilarity#idf(int, int) DefaultSimilarity} is:
 *
 *      <br>&nbsp;<br>
 *      <table cellpadding="2" cellspacing="2" border="0" align="center" style="width:auto">
 *        <tr>
 *          <td valign="middle" align="right">
 *            {@link org.apache.lucene33.search.DefaultSimilarity#idf(int, int) idf(t)}&nbsp; = &nbsp;
 *          </td>
 *          <td valign="middle" align="center">
 *            1 + log <big>(</big>
 *          </td>
 ...
 *      {@link org.apache.lucene33.search.DefaultSimilarity#queryNorm(float) DefaultSimilarity}
 ...
 *          <td valign="middle" align="right" rowspan="1">
 *            queryNorm(q)  &nbsp; = &nbsp;
 *            {@link org.apache.lucene33.search.DefaultSimilarity#queryNorm(float) queryNorm(sumOfSquaredWeights)}
 *            &nbsp; = &nbsp;
 *          </td>
 ...
 *      computed by the query {@link org.apache.lucene33.search.Weight} object.
 *      For example, a {@link org.apache.lucene33.search.BooleanQuery}
 ...
 *        <tr>
 *          <td valign="middle" align="right" rowspan="1">
 *            {@link org.apache.lucene33.search.Weight#sumOfSquaredWeights() sumOfSquaredWeights} &nbsp; = &nbsp;
 *            {@link org.apache.lucene33.search.Query#getBoost() q.getBoost()} <sup><big>2</big></sup>
 *            &nbsp;&middot;&nbsp;
 *          </td>
 *          <td valign="bottom" align="center" rowspan="1" style="text-align: center">
 *            <big><big><big>&sum;</big></big></big>
 ...
 *      {@link org.apache.lucene33.search.Query#setBoost(float) setBoost()}.
 *      Notice that there is really no direct API for accessing a boost of one term in a multi term query,
 *      but rather multi terms are represented in a query as multi
 *      {@link org.apache.lucene33.search.TermQuery TermQuery} objects,
 *      and so the boost of a term in the query is accessible by calling the sub-query
 *      {@link org.apache.lucene33.search.Query#getBoost() getBoost()}.
 *      <br>&nbsp;<br>
 *    </li>
 *
 *    <li>
 ...
 *        {@link org.apache.lucene33.document.Document#setBoost(float) doc.setBoost()}
 *        before adding the document to the index.
 *        </li>
 *        <li><b>Field boost</b> - set by calling
 *        {@link org.apache.lucene33.document.Fieldable#setBoost(float) field.setBoost()}
 ...
 *          <td valign="middle" align="right" rowspan="1">
 *            norm(t,d) &nbsp; = &nbsp;
 *            {@link org.apache.lucene33.document.Document#getBoost() doc.getBoost()}
 *            &nbsp;&middot;&nbsp;
 *            lengthNorm
 *            &nbsp;&middot;&nbsp;
 *          </td>
 ...
 *          </td>
 *          <td valign="middle" align="right" rowspan="1">
 *            {@link org.apache.lucene33.document.Fieldable#getBoost() f.getBoost}()
 *          </td>
 *        </tr>
 *        <tr valigh="top">
 *          <td></td>
 ...
 *      {@link org.apache.lucene33.store.Directory directory} and
 ...
 * @see org.apache.lucene33.index.IndexWriter#setSimilarity(Similarity)
...
public abstract class Similarity implements Serializable {
   ...
   * {@link org.apache.lucene33.index.IndexWriter#addDocument(org.apache.lucene33.document.Document)}
   ...
   *
   * @see org.apache.lucene33.document.Field#setBoost(float)
   *
   ...
   * for some fields.</b>
   * @see org.apache.lucene33.document.Field#setBoost(float)
   * @see org.apache.lucene33.util.SmallFloat
   */
   ...
   * {@link org.apache.lucene33.index.IndexReader#numDocs() IndexReader#numDocs()} because also
