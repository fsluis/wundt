 ...
 * <p/>
 * This filter does not cache.  See the {@link org.apache.lucene33.search.CachingSpanFilter} for a wrapper that
 * caches.
 */
public class SpanQueryFilter extends SpanFilter {
   ...
   * <code>query</code>.
   * @param query The {@link org.apache.lucene33.search.spans.SpanQuery} to use as the basis for the Filter.
   */
