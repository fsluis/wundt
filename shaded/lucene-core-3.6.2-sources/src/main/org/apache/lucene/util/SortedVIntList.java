...
import org.apache.lucene33.search.DocIdSet;
import org.apache.lucene33.search.DocIdSetIterator;
 ...
 * borrowed from {@link org.apache.lucene33.store.IndexInput} and
 * {@link org.apache.lucene33.store.IndexOutput}.
 * <p>
...
public class SortedVIntList extends DocIdSet {
  ...
  private class SortedVIntListBuilder {
    ...
    void addInt(int nextInt) {
      ...
      // See org.apache.lucene33.store.IndexOutput.writeVInt()
  ...
  public DocIdSetIterator iterator() {
    return new DocIdSetIterator() {
      ...
      private void advance() {
        // See org.apache.lucene33.store.IndexInput.readVInt()
