package org.apache.lucene33.util;
...
import org.apache.lucene33.analysis.tokenattributes.CharTermAttributeImpl; // deprecated

/**
 * Base class for Attributes that can be added to a 
 * {@link org.apache.lucene33.util.AttributeSource}.
 * <p>
 * Attributes are used to add data in a dynamic, yet type-safe way to a source
 * of usually streamed objects, e. g. a {@link org.apache.lucene33.analysis.TokenStream}.
 */
public abstract class AttributeImpl implements Cloneable, Serializable, Attribute {  
  ...
  private boolean assertExternalClass(Class<? extends AttributeImpl> clazz) {
    ...
    return (!name.startsWith("org.apache.lucene33.") && !name.startsWith("org.apache.solr."))
      || name.equals("org.apache.lucene33.util.TestAttributeSource$TestAttributeImpl");
  }
