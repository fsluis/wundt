# From https://github.com/mlr-org/mlr3pipelines/blob/pipeop_filterrows/R/PipeOpFilterRows.R
library(R6)
                           ...
                           public = list(
                             initialize = function(id = "filterrows", param_vals = list()) {
                               ps = ParamSet$new(params = list(
                                 ...
                                 ParamUty$new("SDcols", tags = c("train", "predict", "required"), custom_check = checkmate::check_function),
